...
\ctusetup{
   ...
   title-english = {Dual-arm robot perceiving and manipulating soft objects -- use cases},
   title-czech = {Vnímání a manipulování měkkých objektů dvojrukým robotem -- případové studie},
   department-english = {Department of Cybernetics},
   author = {Bc. Tadeáš Lejsek},
   supervisor = {Prof. Ing. Václav Hlaváč, CSc.},
   supervisor-address = {Fakulta elektrotechnická ČVUT,\\ Karlovo náměstí 13,\\
   121 35 Praha 2},
   month = 1,
   year = 2015,
}
...
% Slingshot
\include{Src/03slingshot}

% Knot tying
\include{Src/04tyer}

% Ribbon
\include{Src/05ribbon}

% Regrasping
\include{Src/regrasping}

% Implementation
\include{Src/implementation}

% Conclusions
\include{Src/06conclusions}
